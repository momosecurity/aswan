...
class BaseMenuTable(tables.Table):
    ...
    value = columns.Column(verbose_name=_("值"))
    event_code = columns.Column(verbose_name=_("项目"))
    menu_type = columns.Column(verbose_name=_("名单类型"))
    menu_status = columns.Column(verbose_name=_("状态"))
    menu_desc = TruncateColumn(verbose_name=_("备注"))
    end_time = columns.DateTimeColumn(format="Y-m-d H:i:s", verbose_name=_("结束时间"))
    create_time = columns.DateTimeColumn(format="Y-m-d H:i:s", verbose_name=_("更新时间"))
    creator = columns.Column(verbose_name=_("操作人"))
...
class UseridTable(BaseMenuTable):
    value = columns.Column(verbose_name=_("用户ID"))
...
class IPTable(BaseMenuTable):
    value = columns.Column(verbose_name=_("IP地址"))
...
class UidTable(BaseMenuTable):
    value = columns.Column(verbose_name=_("设备号"))
...
class PayTable(BaseMenuTable):
    value = columns.Column(verbose_name=_("支付账号"))
...
class PhoneTable(BaseMenuTable):
    value = columns.Column(verbose_name=_("手机号"))
